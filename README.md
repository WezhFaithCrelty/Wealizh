Overview
This is a technology mod with an industrial-oriented gameplay and some imaginative elements. Its inspiration comes from the Hbm's Nuclear Tech Mod.
It does not significantly alter the gameplay of the original Minecraft, but adds some new content.
...
For example: qualitative change and electricity. 
...
I gave some examples of block-shaped objects, etc.
Attention
