...
import net.mcreator.wealizh.init.*;
...
@Mod("wealizh")
public class WealizhMod {
	public static final Logger LOGGER = LogManager.getLogger(WealizhMod.class);
	public static final String MODID = "wealizh";

	public WealizhMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		WealizhModSounds.REGISTRY.register(modEventBus);
		WealizhModBlocks.REGISTRY.register(modEventBus);
		WealizhModBlockEntities.REGISTRY.register(modEventBus);
		WealizhModItems.REGISTRY.register(modEventBus);
		WealizhModEntities.REGISTRY.register(modEventBus);
		WealizhModTabs.REGISTRY.register(modEventBus);
		WealizhModMenus.REGISTRY.register(modEventBus);
		WealizhModParticleTypes.REGISTRY.register(modEventBus);
