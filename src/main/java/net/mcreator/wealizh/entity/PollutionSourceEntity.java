...
import net.mcreator.wealizh.procedures.PollutionSourceTickPProcedure;
import net.mcreator.wealizh.procedures.PollutionSourceNBTNumSetPProcedure;

import javax.annotation.Nullable;

public class PollutionSourceEntity extends PathfinderMob {
	public PollutionSourceEntity(EntityType<PollutionSourceEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason reason, @Nullable SpawnGroupData livingdata) {
		...
		PollutionSourceNBTNumSetPProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		PollutionSourceTickPProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
