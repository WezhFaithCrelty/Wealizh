...
import net.mcreator.wealizh.procedures.EntityTickCntMaxGreaterThanRemoveSelfPProcedure;

public class TemporaryEntityEntity extends PathfinderMob {
	public TemporaryEntityEntity(EntityType<TemporaryEntityEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		EntityTickCntMaxGreaterThanRemoveSelfPProcedure.execute(this);
	}
