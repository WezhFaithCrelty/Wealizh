...
public class LigniteBlockBlock extends Block {
	public LigniteBlockBlock(BlockBehaviour.Properties properties) {
		super(properties.mapColor(MapColor.TERRACOTTA_BROWN).strength(5f, 6f).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.XYLOPHONE));
	}

	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(WealizhModBlocks.LIGNITE_BLOCK.get(), properties);
		}
