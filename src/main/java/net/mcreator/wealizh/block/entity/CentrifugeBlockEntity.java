...
public class CentrifugeBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public CentrifugeBlockEntity(BlockPos position, BlockState state) {
		super(WealizhModBlockEntities.CENTRIFUGE.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CentrifugeGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
