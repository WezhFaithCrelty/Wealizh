...
public class QuantitativeTransformationReconstructorGUIScreen extends AbstractContainerScreen<QuantitativeTransformationReconstructorGUIMenu> implements WealizhModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("wealizh:textures/screens/quantitative_transformation_reconstructor_gui.png");
	...
	public QuantitativeTransformationReconstructorGUIScreen(QuantitativeTransformationReconstructorGUIMenu container, Inventory inventory, Component text) {
