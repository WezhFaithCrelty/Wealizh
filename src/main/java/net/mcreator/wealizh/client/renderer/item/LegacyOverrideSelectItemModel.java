package net.mcreator.wealizh.client.renderer.item;
...
public class LegacyOverrideSelectItemModel implements ItemModel {
	...
	public static void registerItemModelTypes(RegisterItemModelsEvent event) {
		event.register(ResourceLocation.parse("wealizh:legacy_overrides"), LegacyOverrideSelectItemModel.Unbaked.MAP_CODEC);
	}
}