...
public class AluminumCopperAlloyBatteryItem extends Item {
	public AluminumCopperAlloyBatteryItem(Item.Properties properties) {
		super(properties.durability(2500));
	}
