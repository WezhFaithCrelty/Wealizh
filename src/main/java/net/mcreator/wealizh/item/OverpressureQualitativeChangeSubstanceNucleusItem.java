...
public class OverpressureQualitativeChangeSubstanceNucleusItem extends Item {
	public OverpressureQualitativeChangeSubstanceNucleusItem(Item.Properties properties) {
		super(properties.durability(396));
	}
