...
public class QualitativeChangeSubstanceNucleusItem extends Item {
	public QualitativeChangeSubstanceNucleusItem(Item.Properties properties) {
		super(properties.durability(124));
	}
