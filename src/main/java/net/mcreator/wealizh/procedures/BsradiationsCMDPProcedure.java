...
public class BsradiationsCMDPProcedure {
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments, Entity entity) {
		if (entity == null)
			return;
		BsRadiationsPProcedure.execute(world, commandParameterBlockPos(arguments, "origin").getX(), commandParameterBlockPos(arguments, "origin").getY(), commandParameterBlockPos(arguments, "origin").getZ(),
				DoubleArgumentType.getDouble(arguments, "DV"), DoubleArgumentType.getDouble(arguments, "GS"), DoubleArgumentType.getDouble(arguments, "pow"));
			...
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal(((new ItemStack(WealizhModItems.LANGUAGE_TESTER.get()).getDisplayName().getString()).equals("[\u6587]")
						? "\u5DF2\u5728" + commandParameterBlockPos(arguments, "origin").getX() + " " + commandParameterBlockPos(arguments, "origin").getY() + " " + commandParameterBlockPos(arguments, "origin").getZ()
								+ "\u5904\u91CA\u653E\u4E86\u6838\u4FB5\u67D3"
						: "The bs-radiations has been released " + commandParameterBlockPos(arguments, "origin").getX() + " " + commandParameterBlockPos(arguments, "origin").getY() + " " + commandParameterBlockPos(arguments, "origin").getZ())),
						false);
		}
	}
